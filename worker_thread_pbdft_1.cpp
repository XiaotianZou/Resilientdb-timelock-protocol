// Delete the primary node part in the pre-prepare phase: erase line 39-49
// Create escrow class, containg sender information, recipient and the size of the objects.
// Create EsrowManaget
// Question: How to implement escrow? Do we need to implement it as a smart contract,
// or just a simple message type?
